...
class demoSlider():
    def double_slider(self):
        driver = webdriver.Edge()
        driver.get("https://www.snapdeal.com/products/beauty-bath-shower?sort=plrty")
        ...
        sleep(3)
        ActionChains(driver).move_to_element(elem2).pause(1).click_and_hold(elem2).move_by_offset(60, 0).release().perform()
        sleep(3)
slider = demoSlider()
